...
confusion_matrix_path = os.path.join(output_dir, "random-forest_confusion_matrix.png")
...
importances.sort_values(ascending=False)[:10].plot(kind="barh", title="Random Forest Top Features")
feature_importance_path = os.path.join(output_dir, "random-forest_top_features.png")
plt.tight_layout()
